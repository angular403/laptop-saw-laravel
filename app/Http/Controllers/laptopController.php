...
class laptopController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(),[
            ...
            'prices' => 'required|numeric|digits_between:3,6',
            'spesifikasi_umum' => 'nullable|max:255',
        ...
        if($validator->fails()){
            ...
            if($request->file('gambar')){
                ...
                $file_name = strtotime('now').'-'.\Str::random(16).'.'.$ekstensi;
                $path_result = $request->file('gambar')->storeAs('gambar',$file_name,'public');
                $laptop->Gambar = $path_result;
            }
            $laptop->SpesifikasiUmum = $request->spesifikasi_umum;
            $laptop->save();
