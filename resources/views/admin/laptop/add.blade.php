        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <fieldset id="fieldset">
                    ...
                    <div class="form-group m-b-25">
                        <div class="col-12">
                            <label for="emailaddress">Spesifikasi Umum </label>
                            <input class="form-control" name="spesifikasi_umum" type="text"  placeholder="Spesifikasi Umum">
                        </div>
                    </div>
                    <div class="form-group m-b-25">
                        <div class="col-12">
                            <label for="emailaddress">Gambar </label>
                            <div>
