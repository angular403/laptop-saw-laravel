    ...
    <div class="col-12">
        <div class="card-box table-responsive">
            ...
            <div style="margin-top: 20px;margin-bottom:20px" class="form-row">
                ...
                <button onclick="cetakHasil()" id="btn-cetak" class="btn btn-danger btn-sm" style="margin-bottom: 28px">Cetak <i class="fa fa-print"></i></button>
...
@push('scripts')
        <script type="text/javascript">
            ...
            function cetakHasil() {
                ...
                const tanggal_akhir = $("#filter-tanggal-akhir").val()
                const url = `{{url('')}}/cetakhasil?length=999999&start=0&tanggal_awal=${tanggal_awal}&tanggal_akhir=${tanggal_akhir}`
